...
public class Controller03_4 {
  ...
  public String step0(HttpSession session) {
    ...
    // 보통 로그인 과정에서 HttpSession 객체가 생성될것이고,
    // 그 전에 JSP를 실행하는 과정에서 HttpSession 객체가 생성될 것 이다.
    // 따라서 이 메서드처럼 일부러 HttpSession 객체를 생성할 필요는 없다.
  ...
  // 테스트:
  // http://.../app2/c03_3/step1?name=hong
  ...
  // 테스트:
  // http://.../app2/c03_3/step3?tel=1111
  ...
  public String step4(
    ...
    return String.format("이름:%s, 나이:%d, 전화:%s\nDB에 저장\n", name, age, tel);
  }
}