...
public class DispatcherListener implements ActionListener {
  ...
  public DispatcherListener() throws Exception{
    ...
    beanContainer.put("member/udate", new MemberUpdateListener(memberDao, sqlSessionFactory));
    ...
    beanContainer.put("board/udate", new BoardUpdateListener(1, boardDao, sqlSessionFactory));
    ...
    beanContainer.put("reading/udate", new BoardUpdateListener(2, boardDao, sqlSessionFactory));
