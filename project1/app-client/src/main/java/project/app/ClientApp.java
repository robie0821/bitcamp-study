...
import project.app.handler.GradeAddListener;
import project.app.handler.GradeListListener;
import project.app.handler.GradeUpdateListener;
...
public class ClientApp {
  ...
  public ClientApp() throws Exception{
    Connection con = DriverManager.getConnection(
        "jdbc:mysql://study:1111@localhost:3306/project1db" // JDBC URL
        );
    prepareMenu();
  }
